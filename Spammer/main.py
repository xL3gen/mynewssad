...
def title_thread():
    ...
    while True:
        ...
        os.system(f'title DcHanem - Berkx. URL Spammer | Checked: {Logger.checked} | Claimed: {Logger.claimed} | Proxy Error: {Logger.proxyError} | Elapsed: {elapsed_time}s'.replace('|', '^|'))

if __name__ == "__main__":
    os.system('cls' if os.name == 'nt' else 'clear')
    Logger.systemSize(130, 40)
    Logger.Print_Logo()
    os.system('title DcHanem - Berkx. URL Spammer')
